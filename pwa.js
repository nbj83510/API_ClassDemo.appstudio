...
const cacheName = 'API_KeyClassDemo-2021-10-31 22:06:46.194966'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'API_KeyClassDemo'.length) === 'API_KeyClassDemo') {
